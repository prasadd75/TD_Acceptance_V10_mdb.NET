...
Friend Class clsDBDirect
    ...
    Public Function ConnectADO() As Short
        ...
        'Dim oradb As String = "Data Source=XE;User Id=TD_V10;Password=oracle123;"
        ...
        'dr.Read()
        'strConnect = dr.Item("department_name")
        'conn.Dispose()
        ...
        'strConnect = "Data Source=" & gsDbName & ";User Id=" & gsUsername & ";Password=" & gsPassword
